// src/renderer/game/map/mapData/definition/createForestTempleDefinition.ts
...
export function createForestTempleDefinition(): WorldDefinition {
    const world = new World(30, 35, WORLD_DEFAULT_TILE[MapCategory.TOWN]);
    const objectLayer = new ObjectLayer();

    const mapData = createMapsEvent()[MapId.FOREST_TEMPLE];
